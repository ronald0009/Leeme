...
- Technology is really the core of AWS in any certification. While we won't go too deeply into technical details it is critical to understand a number of details and principles regarding several services offered by AWS. In this module we will review basic core services and more advanced services. We'll also include a number of use cases to help crystallize important concepts you'll need to pass the exam.
